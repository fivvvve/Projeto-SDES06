          ...
          <DropdownMenuPortal>
            ...
            >
              <DropdownMenuItem
                ...
                className="flex cursor-pointer items-center gap-1.5 px-3 py-2 outline-none hover:rounded-t-lg hover:bg-gradient-to-l hover:from-cyan-500 hover:to-cyan-300 hover:text-gray-100"
              >
